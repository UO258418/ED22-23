...
public class TestBench {
	...
	public static void main(String[] args) {
		...
		try
		{
//			System.out.println("<GRAPH PERFORMANCE>");
//			System.out.println("<INIT GRAPH>");
//			TestBench.test("03_Graph_Init.txt", 3, 100, 1000, "GraphPerformanceTest", "initGraph");
//			System.out.println();
//			
//			System.out.println("<FLOYD GRAPH>");
//			TestBench.test("01_Graph_Floyd.txt", 3, 100, 1000, "GraphPerformanceTest", "runFloyd");
//			System.out.println();
//			
//			System.out.println("<DIJKSTRA GRAPH>");
//			TestBench.test("02_Graph_Dijkstra.txt", 3, 100, 1000, "GraphPerformanceTest", "runDijkstra");
//			System.out.println();
...
//			TestBench.test("linear.txt", 3, 0, 50, "Algorithms", "linear");
//			System.out.println();
